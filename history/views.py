...
@user_passes_test(lambda u: (u.username=='ESMValTool4CMIP6') | (u.username=='b324031') | (u.username=='b309143') | (u.username=='b309070') | (u.username=='b380103') | (u.username=='b309008') | (u.username=='b309141') | (u.username=='b309057'))
